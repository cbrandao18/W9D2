...
function (_React$Component) {
  ...
  _createClass(Board, [{
    ...
    value: function renderRows() {
      ...
      return this.props.board.grid.map(function (row, rowIndex) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "row",
          key: "row-".concat(rowIndex)
        }, _this.renderTiles(row, rowIndex));
      });
    }
  }, {
    key: "renderTiles",
    value: function renderTiles(row, rowIndex) {
      var _this2 = this;
      ...
      return row.map(function (tile, tileIndex) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_tile__WEBPACK_IMPORTED_MODULE_1__["default"], {
          key: "row-".concat(rowIndex, "-tile-").concat(tileIndex),
          tile: tile,
...
function (_React$Component) {
  ...
  function Game(props) {
    ...
    var board = new _minesweeper__WEBPACK_IMPORTED_MODULE_0__["Board"](9, 5);
    _this.state = {
      board: board
    };
  ...
  _createClass(Game, [{
    ...
    value: function render() {
      ...
      if (this.state.board.lost() || this.state.board.won()) {
        modalContent = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          className: "modal-screen"
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          className: "modal-content"
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, modalText), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("button", {
          onClick: this.restartGame
        }, "Play Again")));
      }

      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, modalContent, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_board__WEBPACK_IMPORTED_MODULE_2__["default"], {
        board: this.state.board,
